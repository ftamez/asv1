...
import styles from "./Styles/SeguidoresVIPScreenStyles";
...
export default class SeguidoresVIPScreen extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.mainScreen]}>
        <NavBar menuButton={true} rightButton={true} title="Seguidores VIP" />
