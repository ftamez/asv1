...
import styles from "./Styles/RegistrateScreenStyles";
...
export default class RegistrateScreen extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.mainScreen]}>
        <NavBar menuButton={true} rightButton={true} title="Registrate" />
